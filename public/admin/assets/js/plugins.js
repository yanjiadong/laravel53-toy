   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         if($("#tSortable").length > 0)
         {
            ...
            $("#wysiwyg").dataTable({"iDisplayLength": 5, "sPaginationType": "full_numbers","bLengthChange": false,"bFilter": false,"bInfo": false,"bPaginate": true, "aoColumns": [ { "bSortable": false }, null, null, null, null]});
         }
