                        ...
                        for(var i = 0;i<toys_car.data.info.list.length;i++){
                            ...
                            if(toys_car.data.info.list[i].store <= 0){
                                list +='<li class="clear"><div class="fl"><div class="radio" onclick="toys_car.choose('+i+')"><input type="radio" name="toys"></div></div><div class="fl">' +
                                    ...
                                    toys_car.data.info.list[i].old+'</p>' + '<div class="rent"><span class="money">'+toys_car.data.info.list[i].day_price+'天</span><span class="unit">/天</span></div></a></div><div class="fr"><i class="icon icon_del" onclick="toys_car.delGood('+i+')"></i></div></li>';
                            }else{
                                list +='<li class="clear"><div class="fl"><div class="radio" onclick="toys_car.choose('+i+')"><input type="radio" name="toys"></div></div><div class="fl">' +
                                    ...
                                    '<p>适龄'+toys_car.data.info.list[i].old+'</p>' + '<div class="rent"><span class="money">'+toys_car.data.info.list[i].day_price+'天</span><span class="unit">/天</span></div></a></div><div class="fr"><i class="icon icon_del" onclick="toys_car.delGood('+i+')"></i></div></li>';
                            }
                        }
