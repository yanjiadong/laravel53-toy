            ...
            <div class="span12">
                ...
                <div class="block-fluid">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                        ...
                        <tr>
                            <td>收货人电话：</td>
                            <td>{{ !empty($order->receiver_telephone)?substr($order->receiver_telephone,0,3).' '.substr($order->receiver_telephone,3,4).' '.substr($order->receiver_telephone,7,4):'' }}(该用户绑定的手机号：{{$order->user->telephone}})</td>
                        </tr>
                        <tr>
                            <td>收货地址：</td>
