                ...
                <div class="span12">
                    ...
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
                                <input type="text" value="{{$activity->title}}" class="validate[required]" id="title" name="title"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">活动链接：</div>
                            <div class="span9">
                                <input type="text" value="{{$activity->url}}" class="validate[required]" id="url" name="url"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
                        ...
                        <div class="row-form clearfix" id="activity_show" style="{{ $activity->type==1?'':'display:none;' }}">
                            ...
                            <div class="span9">
                                ...
                                <br/>
                                <img src="{{$activity->picture}}" style="margin-top: 10px;height: 94px;width:320px;" class="showimg" id="showPic"/>
                        ...
                        <div class="row-form clearfix" id="help_show" style="{{ $activity->type==2?'':'display:none;' }}">
                            <div class="span3">活动图片：</div>
                            <div class="span9">
                                <input type="file" class="userfile" id="upload2" value="上传图片" name="userfile" accept="image/jpeg,image/png,image/gif,image/jpg">
                                <br/>
                                <img src="{{$activity->picture}}" style="margin-top: 10px;height: 94px;width:320px;" class="showimg" id="showPic2"/>
                        ...
                        <input type="hidden" id="uploadPath" name="uploadPath" value="{{$activity->picture}}" />
        ...
        $(document).ready(function() {
            ...
            $('#submit').click(function(e) {
                ...
                if ($("#validation").validationEngine('validate')) {
                    ...
                    $.post("{{route('activitys.update',['id'=>$activity->id])}}",
                        {title:title,picture:picture,type:type,url:url,_method:_method},
                        function(data){
                            cTip(data);
                        }, "json");
                }
