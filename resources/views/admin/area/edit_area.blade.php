                ...
                <div class="span12">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9"><input type="text" value="{{  $area->name }}" class="validate[required]" id="name"/></div>
                        </div>
        ...
        $(document).ready(function() {
            $('#submit').click(function(e) {
                ...
                if ($("#validation").validationEngine('validate')) {
                    ...
                    $.post("{{route('admin.areas.update_area')}}",
                        {name:name,fid:fid,id:id},
                        function(data){
                            cTip(data);
                        }, "json");
                }
