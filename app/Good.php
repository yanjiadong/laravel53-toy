...
class Good extends Model
{
    ...
    protected $fillable = ['title','price','category_id','category_tag_id','brand_id','brand_country','material','weight','effect','way','desc','store','picture','category_picture','is_new','is_hot','status','sort','video'];
